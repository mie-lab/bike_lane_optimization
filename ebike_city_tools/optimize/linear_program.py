...
def initialize_IP(
    G, edges_bike_list=None, edges_car_list=None, fixed_values=pd.DataFrame(), cap_factor=2, only_double_bikelanes=True
):
...
if __name__ == "__main__":
    ...
    # compute maximal number of paths that could pass through one edge
    ...
    ip = initialize_IP(G, cap_factor=max_paths_one_edge * FACTOR_MAX_PATHS)
    ip.optimize()
