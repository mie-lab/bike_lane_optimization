...
if __name__ == "__main__":
    ...
    for i in range(NR_ITERS):
        ...
        for size in [80, 60]:
            ...
            nx.write_adjlist(G_lane, f"outputs/rebuttal_int_vs_lin/graph_{i}_{size}.gpickle")
            ...
            for OPTIMIZE_EVERY_K in [10, 20]:
                ...
                pd.DataFrame(res_df).to_csv(os.path.join(OUT_PATH, "integer_vs_linear_rebuttal_70.csv"), index=False)
